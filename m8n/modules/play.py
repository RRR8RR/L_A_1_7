...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = "Wa"
        thumb_name = "https://telegra.ph/file/150bac692acda819021d8.jpg"
    ...
    if await is_active_chat(message.chat.id):
        ...
        await message.reply_photo(
            photo="https://telegra.ph/file/150bac692acda819021d8.jpg",
    ...
    os.remove("https://telegra.ph/file/150bac692acda819021d8.jpg")
